float** parallel_neural_network_testing(parallel_convolutional_layer **p,uint16 *feture,uint16 layer,float** image,uint16 image_x,uint16 image_y,uint16 no_class)
{
    int i,j;
    for( i=0;i<layer;i++)
            {
...
void parallel_neural_network_training(parallel_convolutional_layer **p,uint16 *feture,uint16 layer,float** image,uint16 image_x,uint16 image_y,float** train_array)
{
