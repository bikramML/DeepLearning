...
//  GLubyte *img;
  ...
  for(i=0;i<x;i++)
      for(j=0;j<3*y;)
      {
          img[i*y+j]=((GLubyte)Pixel[0][i][j]/65536);//65536);
          img[i*y+j+1]=((GLubyte)Pixel[1][i][j]/65536);//65536);
          img[i*y+j+2]=((GLubyte)Pixel[2][i][j]/65536);//65536);
         // img[i*y+j+3]=1;
