...
float** init_taining_image()
{
    ...
    void  from_image_to_memory(TIFF *image,float **&image_p,uint32 width,uint32 height,uint16 x_start,uint16 y_start,uint16 x_image_size,uint16 y_image_size)
    {
    ...
    void from_image_to_memory(TIFF *image,float ***&image_p,uint32 width,uint32 height,uint16 SamplesPerPixel,uint16 x_start,uint16 y_start,uint16 x_image_size,uint16 y_image_size)
    {
